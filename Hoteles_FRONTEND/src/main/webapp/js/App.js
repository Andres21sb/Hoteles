...
class App {
    ...
    constructor() {
        ...
        //this.dom.querySelector('#app>#modal #apply').addEventListener('click', e => this.hotelesBody());
    ...
    renderMenuItems = () => {
        ...
        html += `
              <li class="nav-item">
                  <a class="nav-link" id="hotelesCR" href="#" data-bs-toggle="modal"> <span><i class="fa fa-address-card"></i></span> Hoteles de Costa Rica </a>
              </li>
            `;

        this.dom.querySelector('#app>#menu #menuItems').replaceChildren();
        this.dom.querySelector('#app>#menu #menuItems').innerHTML = html;
        this.dom.querySelector('#hotelesCR').addEventListener('click', e => this.hotelesBody());
    }

    hotelesBody = () => {
        this.dom.querySelector('#body').replaceChildren(this.hoteles.dom);
    }
